...
const retornar_Datos_Monstruo = async (req, res) => {
    try {
        ...
        const [datosBatalla_Monstruo, metadata2] = await db.query(`SELECT h.nombreHeroe,b.resultado FROM heroes h INNER JOIN batallas b ON h.id_heroe=b.id_heroe WHERE id_monstruo=${id_monstruo}`);
